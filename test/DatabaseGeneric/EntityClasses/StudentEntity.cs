...
namespace test.EntityClasses
{
	...
	
	{
		...
		public StudentEntity(System.Int64 id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for Student which data should be fetched into this Student object</param>
		/// <param name="validator">The custom validator object for this StudentEntity</param>
		public StudentEntity(System.Int64 id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "Student"."Id".<br/>Table field type characteristics (type, precision, scale, length): Bigint, 20, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 Id
		{
			get { return (System.Int64)GetValue((int)StudentFieldIndex.Id, true); }
			set { SetValue((int)StudentFieldIndex.Id, value); }		}

		/// <summary>The Name property of the Entity Student<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Student"."Name".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
