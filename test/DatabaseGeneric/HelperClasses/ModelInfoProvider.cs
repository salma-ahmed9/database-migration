...
namespace test.HelperClasses
{
	...
	internal class ModelInfoProviderCore : ModelInfoProviderBase
	{
		...
		private void InitStudentEntityInfo()
		{
			...
			this.AddElementFieldInfo("StudentEntity", "Id", typeof(System.Int64), true, false, true, false,  (int)StudentFieldIndex.Id, 0, 0, 20);
			this.AddElementFieldInfo("StudentEntity", "Name", typeof(System.String), false, false, false, false,  (int)StudentFieldIndex.Name, 1073741824, 0, 0);
		}
	}
}