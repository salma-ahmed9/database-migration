...
namespace Hospital.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((Hospital.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting DoctorEntity instances in the database.</summary>
		public DataSource2<DoctorEntity> Doctor {	get { return new DataSource2<DoctorEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting PatientEntity instances in the database.</summary>
		public DataSource2<PatientEntity> Patient {	get { return new DataSource2<PatientEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
