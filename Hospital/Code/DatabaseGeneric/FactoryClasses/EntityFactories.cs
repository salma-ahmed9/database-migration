...
namespace Hospital.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, Hospital.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((Hospital.EntityType)entityTypeValue); }
	...
	/// <summary>Factory to create new, empty DoctorEntity objects.</summary>
	[Serializable]
	public partial class DoctorEntityFactory : EntityFactoryBase2<DoctorEntity> 
	{
		/// <summary>CTor</summary>
		public DoctorEntityFactory() : base("DoctorEntity", Hospital.EntityType.DoctorEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new DoctorEntity(fields); }
	}
	...
	{
		/// <summary>CTor</summary>
		public PatientEntityFactory() : base("PatientEntity", Hospital.EntityType.PatientEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new PatientEntity(fields); }
	}
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(Hospital.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(Hospital.EntityType)))
			{
				var factory = GetFactory((Hospital.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Hospital.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Hospital.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case Hospital.EntityType.DoctorEntity:
					return new DoctorEntityFactory();
				case Hospital.EntityType.PatientEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the Hospital.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Hospital.EntityType)Enum.Parse(typeof(Hospital.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((Hospital.EntityType)Enum.Parse(typeof(Hospital.EntityType), leftOperandEntityName, false), joinType, (Hospital.EntityType)Enum.Parse(typeof(Hospital.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (Hospital.EntityType)Enum.Parse(typeof(Hospital.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((Hospital.EntityType)entityTypeValue); }
